...
pstorm() {
  nohup ~/.local/share/JetBrains/Toolbox/scripts/phpstorm "$@" > /dev/null 2>&1 &
}

# Environment variable
export SSH_AUTH_SOCK="$XDG_RUNTIME_DIR/ssh-agent.socket"
export PATH="$PATH:/home/yamada/.config/composer/vendor/bin"
export PATH="$PATH:/home/yamada/.local/share/JetBrains/Toolbox/scripts"
export PATH="$PATH:/home/yamada/.cargo/bin"
